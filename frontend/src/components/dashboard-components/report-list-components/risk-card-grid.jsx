...
function RiskCardGrid({ report }) {
  return (
    <div className="report-card w-full bg-white shadow-md rounded-lg p-4 flex flex-col gap-5 border border-gray-200">
      <div className="image-container w-full h-48 overflow-hidden rounded-md">
        <img
      ...
      <div className="text-container w-full text-justify flex flex-col h-[60%] gap-1.5">
